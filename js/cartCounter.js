                            ...
                            <div class="card card-v h-100">                           
                                 <div class="position-relative">
                                    ...
                                    <div class="btn-add-to-cart">
                                        <a class="btn btn-icon btn-success btn-icon-text btn-s d-flex justify-content-center text" href="javascript:;" style="font-size: 13px;"><i class="i i-check-square"></i>В корзине</a>
                                    </div>
                                </div>
                            </div>`;
        let productCount = parseInt(countElement.value);
