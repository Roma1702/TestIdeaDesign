...
const openCategory = () => {
    ...
    firstLevels.forEach(firstLevel => {
        firstLevel.addEventListener('click', () => {
            catalogBody.innerHTML = `<a class="btn btn-flat btn-icon-text p-3" href="javascript:;" onclick="openCategoryCatalog()">
                                     ...
                                     <a class="btn btn-icon-text btn-flat px-3" href="javascript:;" onclick="openSubCategory(event)">Хлеб и сдоба
                                        <span class="ml-auto"><i class="i i-chevron-right"></i></span>
                                     </a>
                                     <a class="btn btn-icon-text btn-flat px-3" href="javascript:;" onclick="openSubCategory(event)">Кондитерские изделия
                                         <span class="ml-auto"><i class="i i-chevron-right"></i></span>
                                     </a>
                                     <a class="btn btn-icon-text btn-flat px-3" href="javascript:;" onclick="openSubCategory(event)">Сухари, сушки
                                         <span class="ml-auto"><i class="i i-chevron-right"></i></span>
                                     </a>`;
        });
    })
...
const openCategoryCatalog = () => {
    catalogBody.innerHTML = `<h6 class="p-3">Каталог</h6>
                             <a class="btn btn-icon-text btn-flat px-3 selected-category" href="javascript:;" onclick="openCategory()">Label
                                <span class="ml-auto"><i class="i i-chevron-right"></i></span>
                             </a>
                             <a class="btn btn-icon-text btn-flat px-3 selected-category" href="javascript:;" onclick="openCategory()">Label
                                 <span class="ml-auto"><i class="i i-chevron-right"></i></span>
